...
export const postSignup = creds => dispatch => {
  ...
  return (
    Axios.post("https://gifted-perlman-b41e3d.netlify.app/", creds)
      .then(res => {
...
export const getPlants = userId => dispatch => {
  ...
  return Axios.get(`https://gifted-perlman-b41e3d.netlify.app/${userId}`, {
...
export const postPlants = addPlants => dispatch => {
  ...
  return Axios.post(
    `https://gifted-perlman-b41e3d.netlify.app/${userId}/plants/add`,
    addPlants,
...
export const putPlants = (editPlants, plantId) => dispatch => {
  ...
  return Axios.put(
    `https://gifted-perlman-b41e3d.netlify.app/${userId}/my_plant/${plantId}/update`,
    editPlants,
    {
      headers: { Authorization: localStorage.getItem("token") }
    }
...
export const deletePlants = plantId => dispatch => {
  ...
  return Axios.delete(
    `https://gifted-perlman-b41e3d.netlify.app/${userId}/my_plant/${plantId}/remove`,
