...
export const postSignup = creds => dispatch => {
  ...
  return (
    Axios.post("https://water-my-plants365.herokuapp.com/auth/register", creds)
      .then(res => {
...
export const postLogin = creds => dispatch => {
  ...
  return (
    Axios.post("https://water-my-plants365.herokuapp.com/auth/login", creds)
      .then(res => {
...
export const getPlants = userId => dispatch => {
  ...
  return Axios.get(`https://water-my-plants365.herokuapp.com/${userId}`, {
...
export const postPlants = addPlants => dispatch => {
  ...
  return Axios.post(
    `https://water-my-plants365.herokuapp.com/${userId}/plants/add`,
    addPlants,
...
export const putPlants = (editPlants, plantId) => dispatch => {
  ...
  return Axios.put(
    `https://water-my-plants365.herokuapp.com/${userId}/my_plant/${plantId}/update`,
    editPlants,
    {
      headers: { Authorization: localStorage.getItem("token") }
    }
...
export const deletePlants = plantId => dispatch => {
  ...
  return Axios.delete(
    `https://water-my-plants365.herokuapp.com/${userId}/my_plant/${plantId}/remove`,
